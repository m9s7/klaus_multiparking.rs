...
import variationsImg1 from './../../assets/products/MultiBase2072iOutdoor/multibase-2072i-outdoor-table-en.jpg';
			...
			<div className={`${styles.paddingX} ${styles.flexCenter}`}>
				<div className={`${styles.boxWidth}`}>
					<div className="relative w-full">
						<img
							src={bannerIMG}
							alt="MultiBase 2072i Za Spoljnu Upotrebu slika"
...
export default MultiBase2072iOutdoor;
