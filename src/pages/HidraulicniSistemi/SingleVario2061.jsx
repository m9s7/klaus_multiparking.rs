					...
					<div className={`${styles.paddingY} relative`}>
						<main className="p-2">
							<section className="mb-8">
								...
								>
									Garaža na dva nivoa - najfleksibilniji
									parker za naknadnu ugradnju.
								</h2>
								<p className={`${styles.paragraph} mt-4`}>
									SingleVario 2061 je jednostavan i ekonomičan
									način stvaranja dva parking mesta od jednog.
								</p>
								<p className={`${styles.paragraph} mt-4`}>
							...
							<section className="mb-8">
								...
								<div className="md:flex md:justify-between">
									...
									>
										...
										<li>
											Moguća ugradnja u već postojećim
											objektima
										</li>
									</ul>
									<img
										...
										src={
											NEU_schemaclip_singlevario_2061_IMG
										}
						...
						<main className="p-2">
							...
							<section className="mb-8">
								...
								<div className="flex flex-col gap-6 py-4 lg:flex-row lg:flex-wrap">
									...
									<DownloadButton
										href={zip1}
										text="SingleVario-2061-DWG.zip"
									></DownloadButton>
									<DownloadButton
										href={zip2}
										text="SingleVario-2061-DXF.zip"
									></DownloadButton>
									<DownloadButton
										href={zip3}
										text="SingleVario-2061-BIM.zip"
									></DownloadButton>
								</div>
							</section>
						</main>
