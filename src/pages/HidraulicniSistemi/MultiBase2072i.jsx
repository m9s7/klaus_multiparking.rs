						...
						<main className="p-2">
							<section className="mb-8">
								...
								<p className={`${styles.paragraph} mt-4`}>
									MultiBase 2072i je sistem nezavisnog
									parkiranja kreiran sa izvanrednim tehničkim
									inovacijama za parkiranje dva ili četiri
									vozila.
								</p>

								<p className={`${styles.paragraph} mt-4`}>
									Ovaj sistem je jeadan od najkomfornijih
