...
import variationsImg1 from './../../assets/products/MasterVarioR2C/mastervario-r2c-towersystem-1.jpg';
import variationsImg2 from './../../assets/products/MasterVarioR2C/mastervario-r2c-towersystem-2.jpg';

import doc1 from './../../assets/products/MasterVarioR2C/58671840.pdf';
					...
					<div className={`${styles.paddingY} relative`}>
						<main className="p-2">
							<section className="mb-8">
								...
								>
									MasterVario R2C može da smesti više
								...
								<p className={`${styles.paragraph} mt-4`}>
									MasterVario R2C je vrhunsko rešenje za
									...
									i isparkiravanje. Od standardnih automobila
									do SUV vozila - MasterVario R2C prepoznaje
									visinu vašeg vozila i pronalazi odgovarajuće
