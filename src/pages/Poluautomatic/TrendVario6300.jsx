...
import bannerIMG from './../../assets/products/TrendVario6300/header-produkt-halbautom-parksystem-trendvario6300.jpg';

import variationsImg1 from './../../assets/products/TrendVario6300/trendvario-6300-table-en.jpg';

import doc1 from './../../assets/products/TrendVario6300/58965760.pdf';
import doc2 from './../../assets/products/TrendVario6300/58986450.pdf';
...
import zip1 from './../../assets/products/TrendVario6300/TrendVario-6300-DWG.zip';
import zip2 from './../../assets/products/TrendVario6300/TrendVario-6300-DXF.zip';
					...
					<div className={`${styles.paddingY} relative`}>
						<main className="p-2">
							<section className="mb-8">
								...
								>
									PREMIUM POLUAUTOMATSKI PARKING SISTEM SA 3
									NIVOA PARKIRANJA{' '}
								</h2>
								<p
									className={`${styles.paragraph} mt-4 font-semibold italic`}
								>
									TrendVario 6300 stvara više parking mesta na
									maloj površini.{' '}
								</p>
								...
								<p className={`${styles.paragraph} mt-4`}>
									...
									sistema parkira tri vozila jedno iznad
							...
							<section className="mb-8">
								...
								>
									...
									<li>
										10 gridova jedan pored drugog -
										obezbeđuje do 29 parking mesta
									</li>
									<li>
										Ukupna visina: 325 cm do 460 cm sa
						...
						<main className="p-2">
							...
							<section className="mb-8">
								...
								<div className="flex flex-col gap-6 py-4 lg:flex-row lg:flex-wrap">
									...
									<DownloadButton
										href={zip1}
										text="TrendVario-6300-DWG.zip"
									></DownloadButton>
									<DownloadButton
										href={zip2}
										text="TrendVario-6300-DXF.zip"
									></DownloadButton>
									<DownloadButton
										href={zip3}
										text="TrendVario-6300-BIM.zip"
									></DownloadButton>
									<DownloadButton
										href={doc5}
