...
import bannerIMG from './../../assets/products/TrendVario6100plus/header-halbautom-parksystem-trendvario6100_.jpg';

import variationsImg1 from './../../assets/products/TrendVario6100plus/trendvario-6100plus-table-en.jpg';
import variationsImg2 from './../../assets/products/TrendVario6100plus/trendvario-kombinationen.jpg';
import variationsImg3 from './../../assets/products/TrendVario6100plus/trendvario-komibnationen.jpg';

import doc1 from './../../assets/products/TrendVario6100plus/58965720.pdf';
import doc2 from './../../assets/products/TrendVario6100plus/58986410.pdf';
...
import zip1 from './../../assets/products/TrendVario6100plus/TrendVario-6100+-DWG.zip';
import zip2 from './../../assets/products/TrendVario6100plus/TrendVario-6100+-DXF.zip';
						...
						<main className="p-2">
							<section className="mb-8">
								...
								>
									...
									sa jamom kroz koji se može voziti.{' '}
								</h2>
								<p
									className={`${styles.paragraph} mt-4 font-semibold italic`}
								>
									TrendVario 6100+ sa izuzetno niskom visinom
									prostorija i može da se kombinuje sa drugim
									TrendVario modelima.{' '}
								</p>

								<p className={`${styles.paragraph} mt-4`}>
									TrendVario 6100+ je prolazni parking sistem
							...
							<section className="mb-8">
								...
								>
									...
									<li>
										{' '}
										Ukupna visina: 220 cm do 265 cm sa
										povećanjem od po 5 cm{' '}
									</li>
									<li>
										{' '}
										Dubina jame: 190 cm do 240 cm sa
										povećanjem od po 5 cm{' '}
									</li>
						...
						<main className="p-2">
							...
							<section className="mb-8">
								...
								<div className="flex flex-col gap-6 py-4 lg:flex-row lg:flex-wrap">
									...
									<DownloadButton
										href={zip1}
										text="TrendVario-6100-plus-DWG.zip"
									></DownloadButton>
									<DownloadButton
										href={zip2}
										text="TrendVario-6100-plus-DXF.zip"
									></DownloadButton>
									<DownloadButton
										href={zip3}
										text="TrendVario-6100-plus-BIM.zip"
									></DownloadButton>
									<DownloadButton
										href={doc5}
...
export default TrendVario6100plus;
